...
@WebServlet("/owner/coupon")
public class OwnerCouponServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            if ("add".equals(action)) {
                ...
                Coupon c = new Coupon(0, code, discountType, discountValue, restaurant.getId(), startTime, endTime, minOrderAmount, true);
                ...
                if (c != null && c.getRestaurantId() != null && c.getRestaurantId().equals(restaurant.getId())) {
                    c.setCode(code);
            ...
            System.err.println("[OwnerCouponServlet] operation failed: " + e.getMessage());
        }
